...
public class Intro {
	...
	public static void gridIntro(){
		...
		String filename = "/proj/ciptmp/vy11pyce/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";
		...
		String outFilename ="/home/cip/medtech2011/vy11pyce/mr12out.tif";
		//IJ.save(ImageUtil.wrapGrid2D(mrImage), outFilename);
	}
	...
	public static void signalIntro()
	{
		...
		{
			double val = Math.sin(2.0*Math.PI * stepSize * (double) i);
			y[i] = val;
